...
QString FxsGroup::interUrls [] = {
	...
	QString("comun.i_full_sin"),QString("comun.i_full_cos"),
	QString("comun.i_accell"),QString("comun.i_deccell"),QString("comun.i_rand"),
	QString("comun.i_log"),
	QString("comun.i_b_ease_in"),QString("comun.i_b_ease_out")
	,QString("comun.i_b_ease_in_out"),QString("comun.i_b_cubic"),
	QString("comun.i_b_backstart"),QString("comun.i_b_boing")
};
