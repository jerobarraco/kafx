...
class Tradu(common.Fx):#AVANZADO! si no entendes no importa
...
class FxsGroup(common.FxsGroup):
	...
	def __init__(self):
		...
		self.syl_out_ms = 500 #ms para la animacion de cada silaba muerta (en el dialogo actual)
